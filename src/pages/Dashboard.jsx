  ...
  return (
    <>
      <div className="container py-3">
        <section>
          <h5 className="text-secondary text-uppercase mb-2">Dashboard</h5>
          <h3 className="fw-bold">Hello {person?.username}</h3>
          <hr />
        </section>
          ...
          <div className="mb-3">
            <div className="card">
              <div className="card-body">
                ...
                <h5 className="card-title fw-semibold">{person?.username}</h5>
            ...
            {person.is_client ? (
              <>
                <div className="d-flex align-items-center justify-content-between mb-3">
                  ...
                  <div>
                    <Link to={links?.Projects} className="btn btn-outline-dark">
                      Projects
                    </Link>
                  </div>
                </div>
                  ...
                  <div className="col-md-6 col-sm-12 mb-3">
                    <div className="card">
                      <div className="card-body">
                        ...
                        <p className="card-text">{projects?.count}</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-6 col-sm-12 mb-3">
                    <div className="card">
                      <div className="card-body">
                        ...
                        <p className="card-text">{pendingProjects?.length}</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <>
                <div className="d-flex align-items-center justify-content-between">
                  ...
                  <div>
                    <Link to={links?.Bids} className="btn btn-outline-dark btn-sm">
                      Your Bids
                    </Link>
                  </div>
                </div>
